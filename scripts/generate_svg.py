...
def generate_owner_donut_chart(owner: Dict[str, Any], title: str, style: Dict[str, Any], out_path: Path) -> None:
    ...
    primary_x = style_int(style, "ownerDonutChart.primaryX", 44)
    secondary_x = style_int(style, "ownerDonutChart.secondaryX", 520)

    text_gap = style_int(style, "ownerDonutChart.ownerTextGap", 28)
    parts.append(f'<rect x="{primary_x}" y="{owner_y}" width="{swatch_size}" height="{swatch_size}" rx="{swatch_radius}" fill="{primary_color}"/>')
    parts.append(svg_text(primary_x + text_gap, owner_y + style_int(style, "ownerDonutChart.ownerLabelBaselineOffset", 16), primary_name, size=text_size(style, "ownerLabel", 22), weight=text_weight(style, "ownerLabel", "700"), fill=style_str(style, "colors.owner.primaryText", "#1E3A8A"), font_family=font_family))
    parts.append(svg_text(primary_x + text_gap, owner_y + style_int(style, "ownerDonutChart.ownerValueBaselineOffset", 54), f"{primary}件", size=text_size(style, "ownerValue", 32), weight=text_weight(style, "ownerValue", "700"), fill=style_str(style, "colors.text", "#111827"), font_family=font_family))
    parts.append(svg_text(primary_x + text_gap, owner_y + style_int(style, "ownerDonutChart.ownerPercentBaselineOffset", 84), f"{primary_pct}%", size=text_size(style, "ownerPercent", 20), weight=text_weight(style, "ownerPercent", "600"), fill=style_str(style, "colors.muted", "#6B7280"), font_family=font_family))

    parts.append(f'<rect x="{secondary_x}" y="{owner_y}" width="{swatch_size}" height="{swatch_size}" rx="{swatch_radius}" fill="{secondary_color}"/>')
    parts.append(svg_text(secondary_x + text_gap, owner_y + style_int(style, "ownerDonutChart.ownerLabelBaselineOffset", 16), secondary_name, size=text_size(style, "ownerLabel", 22), weight=text_weight(style, "ownerLabel", "700"), fill=style_str(style, "colors.owner.secondaryText", "#166534"), font_family=font_family))
    parts.append(svg_text(secondary_x + text_gap, owner_y + style_int(style, "ownerDonutChart.ownerValueBaselineOffset", 54), f"{secondary}件", size=text_size(style, "ownerValue", 32), weight=text_weight(style, "ownerValue", "700"), fill=style_str(style, "colors.text", "#111827"), font_family=font_family))
    parts.append(svg_text(secondary_x + text_gap, owner_y + style_int(style, "ownerDonutChart.ownerPercentBaselineOffset", 84), f"{secondary_pct}%", size=text_size(style, "ownerPercent", 20), weight=text_weight(style, "ownerPercent", "600"), fill=style_str(style, "colors.muted", "#6B7280"), font_family=font_family))
